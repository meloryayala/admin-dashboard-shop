...
export const verifyExchange = (
    ...
    if (receivedStatus === 'open') {
        setStatusItems({
            style: 'col-span-2 badge badge-outline badge-warning bg-amber-50 px-3 py-5 w-full space-x-2',
        ...
        setStatusItems({
            style: 'col-span-2 badge badge-outline badge-success bg-teal-50 px-3 py-5 w-full space-x-2',
